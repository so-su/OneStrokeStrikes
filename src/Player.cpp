...
Player::Player():hp(1000),max_hp(1000),ap(0),max_ap(1000),sp(0),max_sp(1000),hp_bar(Rect{100,750,800,20},MyColor::Green),ap_bar(Rect{950,750,100,20},MyColor::Red),sp_bar(Rect{1100,750,100,20},MyColor::Blue){
